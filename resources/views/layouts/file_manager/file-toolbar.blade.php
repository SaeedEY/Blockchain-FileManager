@section('file-toolbar')
	<div class="container-fluid">
		...
		<ul class="collapse navbar-collapse nav navbar-nav navbar-right" id="options">
			...
			<li><a href="#"><span class="fa fa-lg fa-save" onclick="document.forms.edit_file.submit()"></span></a></li>
		</ul>

		<div class="collapse navbar-collapse" id="pb-filemng-navigation">
			<ul class="nav navbar-nav">
				<li><a href=""><span class="fa fa-lg fa-close" onclick="window.close();"></span></a></li>
				...
				<!-- <li><a href="#"><img src="/images/new-folder.png" style="width:25px"></span></a></li> -->
				<!-- <li><a href="#"><img src="/images/new-file.png" style="width:20px"></span></a></li></a></li> -->
			</ul>
		</div>
	</div>
@endsection